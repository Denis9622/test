  ...
  "node_modules/ion-rangeslider/js/ion.rangeSlider.min.js"(exports) {
    !function(i) {
      ...
      Function.prototype.bind || (Function.prototype.bind = function(o2) {
        ...
        if (0 == e2) return -1;
        var h2 = +i2 || 0;
        if (Math.abs(h2) === 1 / 0 && (h2 = 0), e2 <= h2) return -1;
      ...
      h.prototype = { init: function(t2) {
        ...
        if (0 === t2) return this.options.min;
        if (100 === t2) return this.options.max;
        ...
        if ("string" == typeof s2.min && (s2.min = +s2.min), "string" == typeof s2.max && (s2.max = +s2.max), "string" == typeof s2.from && (s2.from = +s2.from), "string" == typeof s2.to && (s2.to = +s2.to), "string" == typeof s2.step && (s2.step = +s2.step), "string" == typeof s2.from_min && (s2.from_min = +s2.from_min), "string" == typeof s2.from_max && (s2.from_max = +s2.from_max), "string" == typeof s2.to_min && (s2.to_min = +s2.to_min), "string" == typeof s2.to_max && (s2.to_max = +s2.to_max), "string" == typeof s2.grid_num && (s2.grid_num = +s2.grid_num), s2.max < s2.min && (s2.max = s2.min), h2) for (s2.p_values = [], s2.min = 0, s2.max = h2 - 1, s2.step = 1, s2.grid_num = s2.max, s2.grid_snap = true, i2 = 0; i2 < h2; i2++) t2 = +e2[i2], t2 = isNaN(t2) ? e2[i2] : (e2[i2] = t2, this._prettify(t2)), s2.p_values.push(t2);
        ...
        if (this.options.grid) {
          ...
          for (this.calcGridMargin(), r.grid_snap && (a2 = n / r.step), 50 < a2 && (a2 = 50), s2 = this.toFixed(100 / a2), 4 < a2 && (l2 = 3), 7 < a2 && (l2 = 2), 14 < a2 && (l2 = 1), 28 < a2 && (l2 = 0), t2 = 0; t2 < a2 + 1; t2++) {
            for (o2 = l2, 100 < (c2 = this.toFixed(s2 * t2)) && (c2 = 100), e2 = ((this.coords.big[t2] = c2) - s2 * (t2 - 1)) / (o2 + 1), i2 = 1; i2 <= o2 && 0 !== c2; i2++) _2 += '<span class="irs-grid-pol small" style="left: ' + this.toFixed(c2 - e2 * i2) + '%"></span>';
        ...
        for (var h2 = 0, t2 = ["ms", "moz", "webkit", "o"], i2 = 0; i2 < t2.length && !l.requestAnimationFrame; ++i2) l.requestAnimationFrame = l[t2[i2] + "RequestAnimationFrame"], l.cancelAnimationFrame = l[t2[i2] + "CancelAnimationFrame"] || l[t2[i2] + "CancelRequestAnimationFrame"];
